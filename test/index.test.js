...
test('initNodeWithPE', () => {
	...
	expect(mockNode.addEventListener.mock.calls[0]).toEqual(['pointerenter', props2.onPointerEnter, {capture: false}]);
	expect(mockNode.addEventListener.mock.calls[1]).toEqual(['pointerleave', props2.onPointerLeave, {capture: false}]);
...
test('updateNodeWithPE', () => {
	...
	expect(mockNode.addEventListener).toHaveBeenCalledTimes(2);
	expect(mockNode.addEventListener.mock.calls[0]).toEqual(['pointerenter', nextProps1.onPointerEnter, {capture: false}]);
	expect(mockNode.addEventListener.mock.calls[1]).toEqual(['pointerleave', nextProps1.onPointerLeave, {capture: false}]);
	...
	expect(mockNode.removeEventListener.mock.calls[0]).toEqual(['pointerenter', prevProps2.onPointerEnter, {capture: false}]);
	expect(mockNode.removeEventListener.mock.calls[1]).toEqual(['pointerleave', prevProps2.onPointerLeave, {capture: false}]);
	...
	expect(mockNode.addEventListener).toHaveBeenCalledWith('pointermove', nextProps4.onPointerMove, {capture: false});

	expect(mockNode.removeEventListener).toHaveBeenCalledTimes(2);
	expect(mockNode.removeEventListener.mock.calls[0]).toEqual(['pointerenter', prevProps4.onPointerEnter, {capture: false}]);
	expect(mockNode.removeEventListener.mock.calls[1]).toEqual(['pointerleave', prevProps4.onPointerLeave, {capture: false}]);
